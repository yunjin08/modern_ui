  ...
  return (
    ...
    >
      <div className={`flex-1 flex items-start flex-col xl:px-0 sm:px-16 px-6`}>
        <div
          className={`flex flex-row items-center py-[6px] px-4 ${styles.bgGradient} rounded-[10px] mb-2`}
        >
      ...
      >
        ...
        <div
          className={`absolute z-[1] w-[80%] h-[80%] bottom-40 white__gradient`}
        />
        <div
          className={`absolute z-0 w-[50%] h-[50%] righth-20 bottom-20 blue__gradient`}
        />
      </div>
